...
public class Seguridad {
	 ...
	 * @throws IllegalBlockSizeException Si hubo un error con el tamaño de la llave.
	...
	public static byte[] symmetricEncryption (byte[] msg, Key key , String algo)
		...
		algo = algo + 
				(algo.equals(ThreadServidor.DES) || algo.equals(ThreadServidor.AES)?"/ECB/PKCS5Padding":"");
	 ...
	 * @param hash El hash que acompaña al mensaje.
	...
	public static SecretKey keyGenGenerator(String algoritmo) 
		...
		int tamLlave = 0;
		if (algoritmo.equals(ThreadServidor.DES))
			tamLlave = 64;
		else if (algoritmo.equals(ThreadServidor.AES))
			tamLlave = 128;
		else if (algoritmo.equals(ThreadServidor.BLOWFISH))
			tamLlave = 128;
		else if (algoritmo.equals(ThreadServidor.RC4))
			tamLlave = 128;
	...
	public static KeyPair generateRSAKeyPair() throws NoSuchAlgorithmException {
		...
		KeyPairGenerator kpGen = KeyPairGenerator.getInstance(ThreadServidor.RSA);
